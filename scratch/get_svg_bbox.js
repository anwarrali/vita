...
// Parse path commands
// e.g. "m 313.66406,481.44364 h -5.53125 c -2.9375,-9.4375..."
...
while (i < tokens.length) {
  ...
  if (token === 'm') {
    ...
    // Bezier control points and end point
    ...
    // It might be a continuation of parameters or absolute command
    // Let's assume relative path parsing for basic Inkscape shape
